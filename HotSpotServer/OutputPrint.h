...
void print_weigh_results(){
   ...
   Serial2.println(" records----------------------");
    ...
    Serial2.println(" ID     T   A   S   L    Act     Adj");
   r=0;
        while (r <= rec-1){                                                          //Print all records found in query
           
            Serial2.print( results[r][0]+"\x09");                                    //display all the column values (add tab)
            Serial2.print( results[r][1]+"   ");
            Serial2.print( results[r][2]+"   ");
            Serial2.print( results[r][3]+"   ");
            Serial2.print( results[r][4]+"   ");
            Serial2.print( results[r][5]+"\x09");
            Serial2.print( results[r][6]+"\x09");
            Serial2.println(" ");                                                     
